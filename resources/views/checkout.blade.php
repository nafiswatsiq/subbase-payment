        ...
        <div class="grid w-full overflow-hidden rounded-2xl bg-white shadow-2xl shadow-gray-900/10 ring-1 ring-gray-200 lg:grid-cols-[0.92fr_1.08fr]">
                    ...
                    <div class="mt-10 border-t border-white/10 pt-6">
                        @foreach($plan->features as $feature)
                            <div class="flex items-start gap-3 py-2.5 text-sm text-gray-200">
                                <span class="mt-0.5 grid h-5 w-5 shrink-0 place-items-center rounded-full bg-blue-600 text-white shadow-sm shadow-blue-900/20" aria-hidden="true">
                                    <svg class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="none">
                                        <path d="m4.5 10 3.25 3.25L15.5 5.5" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </span>
            ...
            <section class="bg-white px-5 py-6 sm:px-10 sm:py-10 lg:px-14 lg:py-12">
                ...
                <div class="mt-6 flex items-center justify-center gap-2 text-xs font-medium text-gray-500">
                    <span class="grid h-5 w-5 place-items-center text-gray-400" aria-hidden="true">
                        <svg class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="none">
                            <path d="m4.5 10 3.25 3.25L15.5 5.5" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </span>
