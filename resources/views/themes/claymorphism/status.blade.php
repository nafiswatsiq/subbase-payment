...
<body class="grid min-h-screen place-items-center bg-[#e9edf5] p-4 font-sans text-slate-800 sm:p-8">
    <main class="w-full max-w-xl rounded-[2rem] bg-slate-50 p-6 shadow-[16px_16px_32px_0px_rgba(0,0,0,0.07),-16px_-16px_32px_0px_rgba(255,255,255,0.95)] border border-white sm:p-10">
        ...
        <div class="mt-10 text-center">
            ...
            <p class="mt-7 text-[10px] font-bold uppercase tracking-[0.3em] text-indigo-500">Transaction status / {{ strtoupper($status) }}</p>
            ...
            <p class="mx-auto mt-5 max-w-md text-sm leading-6 text-slate-600">
        ...
        <div class="mt-8 rounded-2xl bg-indigo-50 p-4 text-xs leading-5 text-slate-600 shadow-inner">
